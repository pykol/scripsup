...
class FormationAdmin(admin.ModelAdmin):
	list_display = ('nom', 'etablissement', 'email', 'email_pieces_justificatives', 'sujet_email_pieces_justificatives', 'code_parcoursup')
	list_filter = (('etablissement', admin.RelatedOnlyFieldListFilter),)
	list_editable = ('email', 'email_pieces_justificatives', 'sujet_email_pieces_justificatives', )
